...
export default function PainPointsDeckFull() {
  ...
  return (
    <div className="relative w-full bg-[#4a675e] overflow-hidden py-16">
      ...
      {/* Estilos para el scroll nativo invisible en Safari/Chrome */}
              ...
              >
                {painPoints.map((item, index) => (
                  <motion.div
                    ...
                    // Aquí está la magia del ancho completo: w-full y shrink-0
