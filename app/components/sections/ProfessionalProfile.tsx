      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20 items-start relative z-10">
        ...
        <div className="lg:col-span-5 relative w-full max-w-md mx-auto lg:max-w-full lg:mx-0 lg:sticky lg:top-32">
            ...
            >
                <Image 
                    src={janetSpeaker} 
                    alt="Janet Duque - Master Speaker International"
                    fill
        ...
        <div className="lg:col-span-7 mt-8 lg:mt-0 lg:pl-8">
            ...
            <div className="text-stone-600 mb-12 leading-relaxed text-base md:text-lg font-light">
                <p className="mb-4">
                ...
                >
                    <Image 
                      src={grupoMujeres} 
                      alt="Acompañamiento a mujeres - Janet Duque" 
                      fill 
                ...
                >
                    <Image 
                      src={grupoEmpresas} 
                      alt="Bienestar productivo en empresas - Janet Duque" 
                      fill 
                      className="object-cover object-center transition-transform duration-700 hover:scale-105"
                    />
                </motion.div>
            ...
            <div className="flex flex-col gap-6 md:gap-8 mb-12 relative">
                ...
                {credentials.map((cred, index) => (
                    ...
                    >
                        ...
                        <div className="mt-1">
                            <h4 className="font-serif font-bold text-[#2b3d38] text-lg mb-1">{cred.title}</h4>
                            <p className="text-stone-500 text-sm md:text-base leading-relaxed font-light">{cred.text}</p>
                        </div>
                    </motion.div>
                ))}
            </div>
